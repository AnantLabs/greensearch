...
public class FileSparseMatrixElement {
	 ...
	 * @throws IOException
	 */
	FileSparseMatrixElement(File dir, String idf, String ptrstr, int datasize)
			throws IOException {
		this.dir = dir;
		this.idf = idf;
		this.ptrstr = ptrstr;
	...
	private FileChannel getFileToChannel(long num) throws IOException {
		...
		this.f = new File(dir.getPath() + "/" + this.idf + this.ptrstr + "_"
				+ num);
	 ...
	 * @throws IOException
	 */
	private FileChannel storeReady(ByteBuffer bb, FileChannel fc, File f,
			String idf) throws IOException {
